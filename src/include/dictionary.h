...
pmix_regattr_input_t dictionary[] = {
    ...
    {.name = "PMIX_LAUNCH_DIRECTIVES", .string = "pmix.lnch.dirs", .type = PMIX_DATA_ARRAY,
    ...
    {.name = "PMIX_PSETOP_TYPE", .string = "pmix.psetop.type", .type = PMIX_PSETOP_DIRECTIVE,
    ...
    {.name = "PMIX_NODE_OVERSUBSCRIBED", .string = "pmix.ndosub", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_WAIT_FOR_CONNECTION", .string = "pmix.wait.conn", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_ENVARS_HARVESTED", .string = "pmix.evar.hvstd", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_DEBUG_STOP_ON_EXEC", .string = "pmix.dbg.exec", .type = PMIX_INT,
    ...
    {.name = "PMIX_DEBUG_STOP_IN_INIT", .string = "pmix.dbg.init", .type = PMIX_INT,
    ...
    {.name = "PMIX_DEBUG_STOP_IN_APP", .string = "pmix.dbg.notify", .type = PMIX_INT,
    ...
    {.name = "PMIX_BREAKPOINT", .string = "pmix.brkpnt", .type = PMIX_STRING,
    ...
    {.name = "PMIX_IOF_RANK_OUTPUT", .string = "pmix.iof.rank", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_IOF_MERGE_STDERR_STDOUT", .string = "pmix.iof.mrg", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_IOF_OUTPUT_TO_FILE", .string = "pmix.iof.file", .type = PMIX_STRING,
    ...
    {.name = "PMIX_IOF_FILE_PATTERN", .string = "pmix.iof.fpt", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_IOF_OUTPUT_TO_DIRECTORY", .string = "pmix.iof.dir", .type = PMIX_STRING,
     .description = (char *[]){"direct application output into files of form",
                               "\"<directory>/<jobid>/rank.<rank>/stdout[err]\"", NULL}},

    {.name = "PMIX_IOF_FILE_ONLY", .string = "pmix.iof.fonly", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_IOF_LOCAL_OUTPUT", .string = "pmix.iof.local", .type = PMIX_BOOL,
    ...
    {.name = "PMIX_OUTPUT_NOCOPY", .string = "pmix.nocopy", .type = PMIX_BOOL,
